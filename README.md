...
### カスタマイズ
「デザイン」タブでテーマ色、シールド校章、丸印、透かし、ロゼット地紋のプリセットを変更した状態。
...
2. 左パネルの「内容／デザイン／写真」を切り替えて編集する。デザインでは校章・印・透かし・背景地紋のプリセットも選べる。カード上の文字・写真・校章・印は右インスペクタやドラッグ／リサイズでも編集可能。
